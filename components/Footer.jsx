			...
			<div className='container'>
					...
					<div className='col-lg-4 mt-30'>
						<div className='footer__widget footer__subscribe'>
							...
							<p>
								...
								Sapiente cupiditate ullam architecto vitae dicta aliquam
								adipisci commodi expedita.
							</p>

							<form action=''>
								<input type='text' placeholder='work@mail.com' />
								<button>
									<IoIosSend />
								</button>
							</form>
				...
				<div className='footer__bottom ul_li_between mt-50'>
					...
					<ul className='footer__social ul_li mt-20'>
						...
						<li>
							<a href='https://github.com/Anton1636'>
								<TiSocialGithub />
							</a>
						</li>
					</ul>
			...
			<div className='footer__copyright mt-35'>
				<div className='container'>
					<div className='footer__copyright-inner ul_li_between'>
						<div className='footer__copyright-text mt-15'>Copyright ...</div>
