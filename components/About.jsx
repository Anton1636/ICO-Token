						...
						>
							<div className='sec-title mb-35'>
								...
								<h2 className='sec-title__title mb-25'>
									...
									quibusdam asperiores quod perspiciatis.
								</h2>
								<p>
									Lorem ipsum dolor sit amet consectetur adipisicing elit.
									Repudiandae dicta laboriosam dolor quae minus odio fuga
									beatae. Placeat sed dolores tempora aliquam dicta similique
									culpa. Molestiae inventore corrupti possimus a?
								</p>
							</div>
