...
import erc20 from './BagelToken.json'

export const TOKEN_ADDRESS = '0xb91eAEC53164099e4Da7B7B74CD1b8df0B264d2E'
export const ERC20_ABI = erc20.abi
export const OWNER_ADDRESS = '0x8d63da0d65dee7f63af5996110c32acd7fee2911'
export const CONTRACT_ADDRESS = '0x8C87Bd44F4A6cB486A8a3A3506C77FDCecceE65f'
...
export const addTokenToMetaMask = async () => {
	if (window.ethereum) {
		...
		const tokenImage =
			'https://www.powercoin.it/48295-large_default_2x/donut-1-oz-silver-coin-2000-francs-cfa-cameroon-2024.jpg'
